...
struct config_element sprd_front_camera_hardware_config[] = {
	...
	{"picture-size-values", "960x720,640x480"},
	...
	{"max-zoom", "6"},
	{"zoom-ratios", "100,150,200,250,300,350,400"},
	//{"zoom", "100"},
	{"zoom", "0"},
...
struct config_element sprd_back_camera_hardware_config[] = {
	...
	{"preview-size", "640x480"},
#else
	{"preview-size-values", "1920x1088,1280x960,1280x720,960x540,720x540,720x480,640x480,352x288,176x144"},
