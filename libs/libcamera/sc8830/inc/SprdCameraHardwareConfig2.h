...
#if defined(CONFIG_CAMERA_SMALL_PREVSIZE) //for scx15
#ifdef CONFIG_CAMERA_ANDROID_ZSL_CAPTURE
#define BACK_SENSOR_ORIG_WIDTH 720
#define BACK_SENSOR_ORIG_HEIGHT 480
#else
#define BACK_SENSOR_ORIG_WIDTH 1280
#define BACK_SENSOR_ORIG_HEIGHT 960
#endif
#else //scx35
