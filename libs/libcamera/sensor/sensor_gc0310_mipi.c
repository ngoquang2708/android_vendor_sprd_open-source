...
static uint32_t set_GC0310_MIPI_anti_flicker(uint32_t param)
{
	...
	case FLICKER_50HZ:
		...
		GC0310_MIPI_WriteReg(0x05 , 0x01);//hb
		GC0310_MIPI_WriteReg(0x06 , 0xb6);
		GC0310_MIPI_WriteReg(0x07 , 0x00);//vb
		GC0310_MIPI_WriteReg(0x08 , 0x2a);
		...
		GC0310_MIPI_WriteReg(0x2b , 0x06);//6e8//level3 640
		GC0310_MIPI_WriteReg(0x2c , 0x36);
	...
	case FLICKER_60HZ:
		GC0310_MIPI_WriteReg(0xfe, 0x00);
		GC0310_MIPI_WriteReg(0x05, 0x01);
		GC0310_MIPI_WriteReg(0x06, 0xa1);
		GC0310_MIPI_WriteReg(0x07, 0x00);
		GC0310_MIPI_WriteReg(0x08, 0x2a);
		GC0310_MIPI_WriteReg(0xfe, 0x01);
		GC0310_MIPI_WriteReg(0x25, 0x00);//anti-flicker step [11:8]
		GC0310_MIPI_WriteReg(0x26, 0x5a);//anti-flicker step [7:0]

		GC0310_MIPI_WriteReg(0x27, 0x02);//exp level 0  14.28fps
		GC0310_MIPI_WriteReg(0x28, 0x1c);
		GC0310_MIPI_WriteReg(0x29, 0x03);//exp level 1  12.50fps
		GC0310_MIPI_WriteReg(0x2a, 0x84);
		GC0310_MIPI_WriteReg(0x2b, 0x06);//exp level 2  6.67fps
		GC0310_MIPI_WriteReg(0x2c, 0x54);
		GC0310_MIPI_WriteReg(0x2d, 0x07);//exp level 3  5.55fps
		GC0310_MIPI_WriteReg(0x2e, 0x62);
		GC0310_MIPI_WriteReg(0xfe, 0x00);
		break;
