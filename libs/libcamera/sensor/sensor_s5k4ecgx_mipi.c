...
{SENSOR_WRITE_DELAY, 10},//delay 16ms
//==================================================================================                
//02.ETC Setting                                                                                    
//==================================================================================                
...
{0x002A, 0x021A},	
{0x0F12, 0x30D4},	  //REG_TC_IPRM_OpClk4KHz_0  0x34BC  0x30D4
{0x0F12, 0x278D}, 	//REG_TC_IPRM_MinOutRate4KHz_0
{0x0F12, 0x278D}, 	//REG_TC_IPRM_MaxOutRate4KHz_0	
{0x0F12, 0x445C},	  //REG_TC_IPRM_OpClk4KHz_1  0x34BC
{0x0F12, 0x4F1A}, 	//REG_TC_IPRM_MinOutRate4KHz_1
{0x0F12, 0x4F1A}, 	//REG_TC_IPRM_MaxOutRate4KHz_1	
{0x0F12, 0x445C},	  //REG_TC_IPRM_OpClk4KHz_2  0x34BC  0x30D4
{0x0F12, 0x3A98},	//REG_TC_IPRM_MinOutRate4KHz_2
{0x0F12, 0x3A98},	//REG_TC_IPRM_MaxOutRate4KHz_2	
...
{0x002A, 0x04E6},	                                      
{0x0F12, 0x077F},	//REG_TC_DBG 7F:Flicker on   5F:Flicker off
...
{0x0F12, 0x0800},	//REG_0TC_CCFG_OIFMask              
...
{0x0028, 0xD000},   //this is D000 page
{0x002A, 0xB0C2},                                                      
{0x0F12, 0x0003},//HS_prepare,{0x0F12, 0x0002},0x03:174nS;0x02:152nS                                                                    
{0x002A, 0xB0C0},                                                      
{0x0F12, 0x0007},//HS_zero,{0x0F12, 0x0008},0x07:338ns                                                                                   
{0x002A, 0xB0D4},                                                      
{0x0F12, 0x0008},//TLPX1f:68ns;0x10:96ns;0x08:236ns;0x0c:396;0x04:194ns
{0x0028, 0x7000},
{0x002A, 0x18AC},
{0x0F12, 0x0060}, //senHal_uAddColsBin
{0x0F12, 0x0060}, //senHal_uAddColsNoBin
...
LOCAL const SENSOR_REG_T s5k4ec_1600X1200[] =
{
	...
	{0x0F12, 0x3A98},	//REG_0TC_PCFG_usMinOut4KHzRate 		
	{0x0F12, 0x0100},	//REG_0TC_PCFG_OutClkPerPix88			
	{0x0F12, 0x0300},	//REG_0TC_PCFG_uBpp88					
	{0x0F12, 0x0042},	//REG_0TC_PCFG_PVIMask					
	{0x0F12, 0x0800},	//REG_0TC_PCFG_OIFMask					
	{0x0F12, 0x01E0},	//REG_0TC_PCFG_usJpegPacketSize 		
	{0x0F12, 0x0000},	//REG_0TC_PCFG_usJpegTotalPackets		
	{0x0F12, 0x0002},	//REG_0TC_PCFG_uClockInd				
	{0x0F12, 0x0000},	//REG_0TC_PCFG_usFrTimeType 			
...
{0x0F12, 0x0800},	//0A20	//REG_0TC_CCFG_usWidth //2560                                                       
{0x0F12, 0x0600},	//0798	//REG_0TC_CCFG_usHeight //1920                                                      
{0x0F12, 0x0005},	//REG_0TC_CCFG_Format //5:YUV, 7:RAW, 9:JPEG                                        
{0x0F12, 0x278D},	//NCMCv21(Case3-13) 2FC2->2C09 //27BD //4F1A	//REG_0TC_CCFG_usMaxOut4KHzRate                                             
{0x0F12, 0x278D},	//NCMCv21(Case3-13) 2FB2->2C00 //275D //4F1A	//REG_0TC_CCFG_usMinOut4KHzRate
{0x0F12, 0x0100},	//REG_0TC_CCFG_OutClkPerPix88
{0x0F12, 0x0300},	//REG_0TC_CCFG_uBpp88
{0x0F12, 0x0042},	//NCMCv21(Case3-11) 0042->0012 //REG_0TC_CCFG_PVIMask //[1]:PCLK Inversion
{0x0F12, 0x0800},	//REG_0TC_CCFG_OIFMask
{0x0F12, 0x0810},	//REG_0TC_CCFG_usJpegPacketSize //2064d
{0x0F12, 0x0900},	//REG_0TC_CCFG_usJpegTotalPackets //Must be multiples of 16
...
LOCAL SENSOR_REG_TAB_INFO_T s_s5k4ec_resolution_Tab_YUV[] = {
	...
	//{ADDR_AND_LEN_OF_ARRAY(s5k4ec_1280X960), 1280, 960, 24, SENSOR_IMAGE_FORMAT_YUV422},
	//{ADDR_AND_LEN_OF_ARRAY(s5k4ec_1600X1200), 1600, 1200, 24, SENSOR_IMAGE_FORMAT_YUV422},
	//{ADDR_AND_LEN_OF_ARRAY(s5k4ec_2592X1944), 2592, 1944, 24,	 SENSOR_IMAGE_FORMAT_YUV422},
	//{ADDR_AND_LEN_OF_ARRAY(s5k4ec_1280X960), 1280, 960, 24, SENSOR_IMAGE_FORMAT_YUV422},
#endif	
	...
	{PNULL, 0, 0, 0, 0, 0},
#else
	{ADDR_AND_LEN_OF_ARRAY(s5k4ec_1600X1200), 1600, 1200, 24,
	 SENSOR_IMAGE_FORMAT_YUV422},
	{ADDR_AND_LEN_OF_ARRAY(s5k4ec_2048X1536), 2048, 1536, 24,
	 SENSOR_IMAGE_FORMAT_YUV422},
	{ADDR_AND_LEN_OF_ARRAY(s5k4ec_2592X1944), 2560, 1920, 24,
	 SENSOR_IMAGE_FORMAT_YUV422},
#endif	 
	{PNULL, 0, 0, 0, 0, 0},
	{PNULL, 0, 0, 0, 0, 0},
