...
LOCAL const SENSOR_REG_T2 dcam_patterncommon_init_RAWRGB[] = {
	{DCAM_CFG,PATTERN_SEL },
	{REG_PATTERN_SIZE, 0x00},
	{REG_PATTERN_VBLANK, 0x00},
	{REG_PATTERN_HBLANK, 0x00},
	{REG_PATTERN_CFG, 0x00},
};

LOCAL const SENSOR_REG_T2 dcam_pattern640X480_RAWRGB[] = {
	{DCAM_CFG,PATTERN_SEL },
	{REG_PATTERN_SIZE, (640<<16)|(480)},
	{REG_PATTERN_VBLANK, (3<<16)|(3<<8)|3},
	{REG_PATTERN_HBLANK, 16},
	{REG_PATTERN_CFG, (0<<3)|1},
};

LOCAL const SENSOR_REG_T2 dcam_pattern1280X960_RAWRGB[] = {
	{DCAM_CFG,PATTERN_SEL },
	{REG_PATTERN_SIZE, (1280<<16)|(960)},
	{REG_PATTERN_VBLANK, (3<<16)|(3<<8)|3},
	{REG_PATTERN_HBLANK, 16},
	{REG_PATTERN_CFG, 0},
};
...
static char                     dev_name[50] = "/dev/sprd_patternsensor";
...
LOCAL uint32_t PowerOn(uint32_t power_on)
{
	...
	{
		if(-1 == g_fd_pattern){
		g_fd_pattern = open(dev_name, O_RDWR, 0);
		if (-1 == g_fd_pattern) {
		...
		ret = xioctl(g_fd_pattern, SENSOR_IO_PD, &power_on);
		}
	}
	else{
		ret = xioctl(g_fd_pattern, SENSOR_IO_PD, &power_on);
...
//		Sensor_SendRegTabToSensor(g_ov5640_yuv_info.resolution_tab_info_ptr+0);
//		Sensor_SendRegTabToSensor(g_ov5640_yuv_info.resolution_tab_info_ptr+1);
	}
#endif
	return ret;
}
...
LOCAL SENSOR_IOCTL_FUNC_TAB_T _ioctl_func_tab = {
	...
	PNULL,			// _write register
	PNULL,			// _read  register
	PNULL,
...
SENSOR_INFO_T g_patternyuv_info = {
	...
	NULL,			//&gext_info,                // extend information about sensor
