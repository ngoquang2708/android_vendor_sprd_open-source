...
#define MALI_IOC_WAIT_FOR_SYSTRACE_GP_NOTIFICATION    _IOWR(MALI_IOC_CORE_BASE, _MALI_UK_WAIT_FOR_SYSTRACE_GP_NOTIFICATION, _mali_uk_wait_for_systrace_notification_s *)
#define MALI_IOC_POST_SYSTRACE_GP_NOTIFICATION        _IOWR(MALI_IOC_CORE_BASE, _MALI_UK_POST_SYSTRACE_GP_NOTIFICATION, _mali_uk_post_systrace_notification_s *)
#define MALI_IOC_WAIT_FOR_SYSTRACE_PP_NOTIFICATION    _IOWR(MALI_IOC_CORE_BASE, _MALI_UK_WAIT_FOR_SYSTRACE_PP_NOTIFICATION, _mali_uk_wait_for_systrace_notification_s *)
#define MALI_IOC_POST_SYSTRACE_PP_NOTIFICATION        _IOWR(MALI_IOC_CORE_BASE, _MALI_UK_POST_SYSTRACE_PP_NOTIFICATION, _mali_uk_post_systrace_notification_s *)
#endif
