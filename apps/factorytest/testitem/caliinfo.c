...
int test_cali_info(void)
{
	...
	{
		LOGD("mmitest cali_size<text_rows\n");
		for(i=0;i<row_num;i++)
		{
	...
	else
	{
		do{
			...
			for(i=0;i<row_num+2-text_rows;i++)
			{
				if(strstr(tmp6[text_rows-2+i],"Fail")!=NULL)
					ui_set_color(CL_RED);
				if(strstr(tmp6[text_rows-2+i],"Pass")!=NULL)
					ui_set_color(CL_GREEN);
				if(strstr(tmp6[text_rows-2+i],"Not Test")!=NULL)
					ui_set_color(CL_WHITE);
			...
			for(i=0;i<row_num2;i++)
				{
					if(strstr(tmp6[i],"Fail")!=NULL)
						ui_set_color(CL_RED);
					if(strstr(tmp6[i],"Pass")!=NULL)
						ui_set_color(CL_GREEN);
					if(strstr(tmp6[i],"Not Test")!=NULL)
						ui_set_color(CL_WHITE);
