...
static void process_modem_state_message(char *message,int size)
{
	...
	MODEM_LOGD("alive=%d reset=%d flash_less = %d, modem_state = %d \n",alive_status,reset_status,flash_less_flag, modem_state);
	switch(modem_state){
