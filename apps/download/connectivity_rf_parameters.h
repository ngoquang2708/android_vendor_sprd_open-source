...
#define  WIFI_CONFIG_TABLE(NAME, MEM_OFFSET, TYPE)  { NAME, (unsigned int)( &( ((wifi_config_t *)(0))->MEM_OFFSET )), TYPE}
#define  WIFI_CALI_TABLE(NAME, MEM_OFFSET, TYPE)    { NAME, (unsigned int)( &( ((wifi_cali_t *)(0))->MEM_OFFSET )), TYPE}
