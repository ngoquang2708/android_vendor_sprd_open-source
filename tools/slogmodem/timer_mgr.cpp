...
int TimerManager::add_timer(unsigned interval, timer_callback cb,
			    void* param)
{
...
LogList<TimerManager::Timer*>::iterator
TimerManager::find(TimerManager::Timer* t)
{
	LogList<Timer*>::iterator it;
...
int TimerManager::set_new_due_time(TimerManager::Timer* t,
				   unsigned interval)
{
