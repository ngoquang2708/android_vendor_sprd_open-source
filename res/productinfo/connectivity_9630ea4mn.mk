...
PRODUCT_COPY_FILES += \
	...
	$(LOCAL_PATH)/scx35l_sp9630ea3mn_connectivity_configure.ini:prodnv/connectivity_configure.ini \
	$(LOCAL_PATH)/scx35l_sp9630ea3mn_connectivity_configure.ini:prodnv/connectivity_calibration.ini
